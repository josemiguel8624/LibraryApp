...
%-------------------------------------- COMIENZA descripción del caso de uso.
	...
	\begin{UCtrayectoria}{Principal}
			...
			\UCpaso[\UCsist] El sistema despliega \IUref{UI6}{Pantalla Registro} solicitando al usuario que seleccione las  condiciones físicas del libro que aplique.
	...
	\end{UCtrayectoria}
		...
		\begin{UCtrayectoriaA}{A}{El administrador desea cambiar el estado de un libro en concreto.}
			...
			\UCpaso[\UCsist] El sistema despliega la \IUref{UI6}{Pantalla Registro} y solicita al administrador que seleccione la disponibilidad del libro.
