...
\begin{UseCase}{CU04}{Registrar libro}{Se describirá el comportamiento y funcionamiento del sistema para registrar un libro
en una base de datos. El registro se realizará ingresando la información completa del libro acorde al protocolo de identificación MARC 21.}
		\UCitem{Versión}{0.1}
		...
		\UCitem{Salidas}{
			\begin{itemize}
				\item Se registra la informacion del libro.
			\end{itemize}					
		}
		...
		\UCitem{Postcondiciones}{
			\begin{itemize}
				\item Se actualiza en la base de datos la lista de libros con los que cuenta la biblioteca.
			\end{itemize}					
		}
		\UCitem{Autor}{
			\begin{itemize}
