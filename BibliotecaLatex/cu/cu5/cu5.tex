...
%-------------------------------------- COMIENZA descripción del caso de uso.
	...
	\begin{UCtrayectoria}{Principal}
		...
		\UCpaso[\UCactor] El Usuario llena el campo disponible con el nombre del libro y hace clic en el el boton \IUbutton{Buscar} de la \IUref{UI09}{Pantalla Consulta de libros}.
		...
		\UCpaso[\UCsist] El sistema muestra en la intefaz \IUref{UI10}{Pantalla de vista de consulta} los resultados obtenidos, incluyendo el estado del libro.
	\end{UCtrayectoria}
