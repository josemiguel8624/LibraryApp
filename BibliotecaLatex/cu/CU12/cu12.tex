...
%-------------------------------------- COMIENZA descripción del caso de uso.
	...
	\begin{UseCase}{CU12}{Apartar Libro}{
		...
		\UCitem{Salidas}{Orden de Apartado de Libro. Que contendrá: fecha del día en que se hizo la orden, nombre de quien hizo la orden, nombre del libro, autor, id del libro.}
