...
%-------------------------------------- COMIENZA descripción del caso de uso.
	...
	\begin{UCtrayectoria}{Principal}
		...
		\UCpaso[\UCsist] El sistema verifica si el libro no esta disponible conforme a la regla de negocio \BRref{20}{Libro Disponible para Apartado}\Trayref{A}.
		...
		\UCpaso[\UCsist] El sistema validará los datos conforme a las reglas de negocio \BRref{18}{Apartado Libro}\BRref{19}{Apartado para Usuario}\Trayref{B}\Trayref{C}.
